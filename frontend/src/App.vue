        ...
        <ul class="catalog__list">
          ...
          <li class="catalog__item">
            ...
            <ul class="sizes">
              ...
              <li class="sizes__item">
                <label class="sizes__label">
                  <input class="sizes__radio sr-only" type="radio" name="sizes-1" value="128"
                         checked="">
                  <span class="sizes__value">
                    128gb
                  </span>
          ...
          <li class="catalog__item">
            ...
            <ul class="sizes">
              ...
              <li class="sizes__item">
                <label class="sizes__label">
                  <input class="sizes__radio sr-only" type="radio" name="sizes-2" value="128"
                         checked="">
                  <span class="sizes__value">
                    128gb
                  </span>
          ...
          <li class="catalog__item">
            ...
            <ul class="sizes">
              ...
              <li class="sizes__item">
                <label class="sizes__label">
                  <input class="sizes__radio sr-only" type="radio" name="sizes-3" value="128"
                         checked="">
                  <span class="sizes__value">
                    128gb
                  </span>
